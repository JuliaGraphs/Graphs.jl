@testset "Multiroute flow" begin
    ...
    graphs = [
        ...
        (
            ...
            [(0.0, 0.0, 2), (3.0, 6.0, 1), (9.0, 12.0, 0)],  # breaking points
            9.0,                                         # value for 1.5 routes
        ),
        ...
        (
            ...
            [(0.0, 0.0, 4), (1.0, 4.0, 2), (2.0, 6.0, 0)],   # breaking points
            ...
            for AlgoFlow in [
                ...
                for AlgoMrf in [ExtendedMultirouteFlowAlgorithm, KishimotoAlgorithm]
                    for (k, val) in enumerate(froutes)
                        @test multiroute_flow(
                            g,
                            s,
                            t,
                            capacity_matrix;
                            flow_algorithm=AlgoFlow(),
                            mrf_algorithm=AlgoMrf(),
                            routes=k,
                        )[1] ≈ val
                    end
                end
