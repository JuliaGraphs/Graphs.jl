...
@testset "Isomorphism" begin
    ...
    @test has_subgraphisomorph(
        complete_graph(4), complete_graph(3); vertex_relation=vrel
    ) == false
    @test has_subgraphisomorph(complete_graph(4), complete_graph(3); edge_relation=erel) ==
        false
    @test has_induced_subgraphisomorph(
        complete_graph(4), complete_graph(3); vertex_relation=vrel
    ) == false
    @test has_induced_subgraphisomorph(
        complete_graph(4), complete_graph(3); edge_relation=erel
    ) == false
    ...
    @test isempty(
        all_subgraphisomorph(complete_graph(4), complete_graph(3); vertex_relation=vrel)
    )
    @test isempty(
        all_subgraphisomorph(complete_graph(4), complete_graph(3); edge_relation=erel)
    )
    @test isempty(
