...
Graphs.edges(g::GenericGraph) = (GenericEdge(e) for e ∈ Graphs.edges(g.g))
Graphs.edges(g::GenericDiGraph) = (GenericEdge(e) for e ∈ Graphs.edges(g.g))
...
Graphs.inneighbors(g::GenericGraph, v) = (u for u ∈ Graphs.inneighbors(g.g, v))
Graphs.inneighbors(g::GenericDiGraph, v) = (u for u ∈ Graphs.inneighbors(g.g, v))

Graphs.outneighbors(g::GenericGraph, v) = (u for u ∈ Graphs.outneighbors(g.g, v))
Graphs.outneighbors(g::GenericDiGraph, v) = (u for u ∈ Graphs.outneighbors(g.g, v))
...
Graphs.vertices(g::GenericGraph) = (v for v ∈ Graphs.vertices(g.g))
Graphs.vertices(g::GenericDiGraph) = (v for v ∈ Graphs.vertices(g.g))
